...
AS $$
DECLARE
  project_url TEXT := 'https://wljwvlcbwcglogdfpnte.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indsand2bGNid2NnbG9nZGZwbnRlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjI2Nzk3MywiZXhwIjoyMDIxODQzOTczfQ.jJB5DLUafC2D9hCLh1giafFUaJ5AzvZQg6mHdW7NM-M'; -- full access needed for http request to storage
